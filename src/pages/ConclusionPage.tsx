const ConclusionPage = () => {
  return (
    <section className="flex flex-col p-10">
      <h2 className="mb-10 text-3xl">Conclussion</h2>
      <div className="md:w-1/2 flex flex-col gap-10 text-left self-center ">
        <p className="md:w-96">
        ...
        <p className="md:w-96 md:self-end">
          ...
          tristique. Proin nec augue. Quisque aliquam tempor magna. Pellentesque
          habitant morbi tristique senectus et netus et malesuada fames ac
          turpis egestas. Nunc ac magna. <br></br>
        ...
        <p className="md:w-96">
          ...
          fames ac turpis egestas. Proin semper, ante vitae sollicitudin
          posuere, metus quam iaculis nibh, vitae scelerisque nunc massa eget
          pede. Sed velit urna, interdum vel, ultricies vel, faucibus at, quam.
        ...
        <p className="md:w-96 md:self-end">
          Sed ac ligula. Aliquam at eros. Etiam at ligula et tellus ullamcorper
          ultrices. In fermentum, lorem non cursus porttitor, diam urna accumsan
          lacus, sed interdum wisi nibh nec nisl. Ut tincidunt volutpat urna.
          Mauris eleifend nulla eget mauris. Sed cursus quam id felis. Curabitur
